...
DatalakeAccountId="660734235353"
CrossAccountDsnaRole="arn:aws:iam::$DsnaAccountId:role/vci-sagemaker-CrossAccount-DataLake-Access-Role"
TeamTag="itdna"
SUBNETS="subnet-07b8442a392a70796,subnet-0b726e5ee26b8308b,subnet-02f3bbd667c6169d5"
AWSRegion="us-east-1"
VpcId="vpc-06327f958f9dec075"
...
BASE_DIR=../glue
aws cloudformation deploy \
    --template-file $BASE_DIR/glue.yaml \
